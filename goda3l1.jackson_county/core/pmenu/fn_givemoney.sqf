...
if(parseNumber(_amount) > aQ3CGZRg3W9tGxzs) exitWith {hint "You don't have that much to give!";ctrlShow[2001,true];};
if(isNull _unit) exitWith {ctrlShow[2001,true];};
...
aQ3CGZRg3W9tGxzs = aQ3CGZRg3W9tGxzs - (parseNumber(_amount));
