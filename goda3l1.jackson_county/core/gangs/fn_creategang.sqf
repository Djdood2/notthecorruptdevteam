...
if(b2UuDWVw9NeDh45d < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-b2UuDWVw9NeDh45d)] call life_fnc_numberText];};
