...
if(aQ3CGZRg3W9tGxzs < life_bail_amount) exitWith {hint format[localize "STR_NOTF_Bail_NotEnough",life_bail_amount];};
...
if ( side _nearestPlayer == west ) then {
	aQ3CGZRg3W9tGxzs = aQ3CGZRg3W9tGxzs - life_bail_amount;
