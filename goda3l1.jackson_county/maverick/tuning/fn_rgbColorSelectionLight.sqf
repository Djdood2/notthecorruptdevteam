...
((findDisplay 5200) displayCtrl 3) ctrlAddEventHandler ["ButtonClick",{
	...
	closeDialog 0;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'>Underglow successfully added, press SHIFT-L to activate<br/><t color='#12FE00'>$%1</t> left</t>",[aQ3CGZRg3W9tGxzs] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
}];
...
((findDisplay 5200) displayCtrl 4) ctrlAddEventHandler ["ButtonClick",{
	...
	// Refund money
	aQ3CGZRg3W9tGxzs = aQ3CGZRg3W9tGxzs + mav_tuning_rgbprice;
	[format["<t size='1' align='center' shadow='2' font='PuristaMedium'><t color='#12FE00'>$%1</t> have been refunded to your account<br/><t color='#12FE00'>$%2</t> left</t>",[mav_tuning_rgbprice] call BIS_fnc_numberText,[aQ3CGZRg3W9tGxzs] call BIS_fnc_numberText]] spawn mav_tuning_fnc_displayText;
}];
