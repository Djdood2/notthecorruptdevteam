...
switch (_filter) do
{
	case 0:
	{
		_ret set[count _ret,["RAVEN_SO1",nil,100]];
		_ret set[count _ret,["RAVEN_SO2",nil,100]];
		_ret set[count _ret,["RAVEN_SO3",nil,100]];
		_ret set[count _ret,["RAVEN_SO4",nil,100]];
		_ret set[count _ret,["RAVEN_SO5",nil,100]];
		_ret set[count _ret,["RAVEN_SO6",nil,100]];
		_ret set[count _ret,["RAVEN_SO7",nil,100]];
		_ret set[count _ret,["RAVEN_SO8",nil,100]];
	...
	case 3:
	{
		...
		_ret set[count _ret,["SERT_VEST_BLACK",nil,25]];
		_ret set[count _ret,["SO_VEST",nil,25]];
		_ret set[count _ret,["SO_Command_VEST",nil,25]];
