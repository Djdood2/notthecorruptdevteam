...
_mstatus ctrlSetStructuredText parseText format["<t size='1.2px'>$%1</t>",[b2UuDWVw9NeDh45d] call life_fnc_numberText];
_mstatus2 ctrlSetStructuredText parseText format["<t size='1.2'>$%1</t>",[aQ3CGZRg3W9tGxzs] call life_fnc_numberText];
